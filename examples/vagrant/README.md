...
684d8fb23ae5     go               "/app/go-vault-demo"     7 minutes ago     Up 7 minutes     go
dc6a3454b323     vault:0.10.3     "docker-entrypoint..."   7 minutes ago     Up 7 minutes     vault
...
# Check the go logs
[vagrant@demo ~]$ docker logs go -f
```

### Test the App

Invoke the `orders` API at http://localhost:3000/api/orders
...
$ curl --request POST --header "Content-Type: application/json" \
       --data @payload.json http://localhost:3000/api/orders | jq
